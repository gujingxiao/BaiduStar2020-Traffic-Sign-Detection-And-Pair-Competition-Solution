    ...
    for pdSign in pdSigns:
        ...
        for gtSign in gtSigns:
            ...
            if cal_iou(gtBox0, pdBox0) >= 0.5 and type0 == pdtype0 and pic_id0 == pdpic_id0:
                flag = 1
                break
            elif cal_iou(gtBox0, pdBox0) >= 0.5 and type0 != pdtype0 and pic_id0 == pdpic_id0:
                flag = 1
                break

        if flag == 0 and pdtype0 == labels['301']:
            count = count + 1
            image = cv2.imread(
                os.path.join(picPath, pdpic_id0 + '.jpg'))
            ...
            cv2.imwrite(os.path.join(savePath, 'false', pdpic_id0 + '_' + str(count) + '_' + pdSign['type'] + '.png'), roi_image)
            # cv2.rectangle(image, (int(pdBox0[0]), int(pdBox0[1])), (int(pdBox0[2]), int(pdBox0[3])), (0, 255, 0), 2)
...
if __name__ == '__main__':
    ...
    savePath = '/media/gujingxiao/f577505e-73a2-41d0-829c-eb4d01efa827/BaiduStar2020/false_classification/301/val'
    ...
    # picPath = '/media/gujingxiao/f577505e-73a2-41d0-829c-eb4d01efa827/BaiduStar2020/train/pic/'
    # savePath = '/media/gujingxiao/f577505e-73a2-41d0-829c-eb4d01efa827/BaiduStar2020/false_classification/301/train'
