...
@register
@serializable
class TrafficGeneralDataSet(DataSet):
    """
    ...
    def __init__(self,
        ...
        super(TrafficGeneralDataSet, self).__init__(
            image_dir=image_dir,
            anno_path=anno_path,
    ...
    def load_roidb_and_cname2cid(self):
        ...
        # }
        im_info_dict = {}
        cname2cid = trans_label_general(self.with_background)
        ...
        write_im_info_general(self.dataset_dir, im_info_dict)
...
def trans_label_general(with_background=True):
    labels_map = {
        '102': 1,
        '103': 1,
        '104': 1,
...
def write_im_info_general(out_dir, im_info_dict):
